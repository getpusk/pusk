...
export const L={
  ru:{sub:'Платформа алертов',login:'Войти',reg:'Регистрация',demo:'Демо',user:'Логин',pin:'Пароль',
    ...
    new_ch:'Новый канал',new_bot:'Новый бот',cancel:'Отмена',create:'Создать',name_req:'Введите имя',select_bot:'Бот',
    ch_lbl:'Канал',bot_lbl:'Бот',yest:'Вчера',invite:'Пригласить',invited:'Скопировано!',
  ...
  en:{sub:'Bot platform',login:'Login',reg:'Register',demo:'Demo',user:'Username',pin:'Password',
    ...
    new_ch:'New Channel',new_bot:'New Bot',cancel:'Cancel',create:'Create',name_req:'Enter name',select_bot:'Bot',
    ch_lbl:'Channel',bot_lbl:'Bot',yest:'Yesterday',invite:'Invite',invited:'Copied!',
...
export function setLang(){
  ...
  if(typeof translateLanding==='function')translateLanding();
  if($('settings').style.display==='block'||$('settings').style.display==='flex'){if(typeof window._renderSettings==='function')window._renderSettings()}
}
